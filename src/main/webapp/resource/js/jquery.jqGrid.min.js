            ...
            this.each(function() {
                ...
                if (!c.p.filterToolbar) {
                    ...
                    function(b) {
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), f = $.extend({},
                        this.searchoptions || {},
                        {
                            name: r.index || r.name,
                            ...
                            $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})), $(p).css({
                                width: "100%"
                            }).addClass(g.srInput), $("td:eq(1)", w).append(p), $(v).append(w), this.stype) {
                            case "select":
